...
class Bar < ActiveRecord::Base
  include ActionService::ORM::Guard
end
...
describe ActionService::ORM::ActiveRecord do
  before(:all) do
    begin
      mig = Migration.new
  ...
  describe :Drinking do
    ...
    it "should not create a bar w/o scrubbing" do
      ...
      }.to raise_error(ActionService::ORM::Unscrubbed)
    end
    ...
    it "should build a clean joint" do
      ...
      }.to_not raise_error(ActionService::ORM::Unscrubbed)
    end
